...
export default function TimelineSection() {
  const timelineEvents = [
    ...
    { time: "5:00 PM", title: "COPTEL", icon: Heart },
    ...
    <section id="timeline" className="py-16 px-6 bg-[#f5f1eb] text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 bg-[#51131d] h-full"></div>
          ...
          {timelineEvents.map((event, index) => {
            ...
            return (
              <div key={index} className="relative mb-12 last:mb-0">
                {/* Punto del timeline */}
                <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#51131d] rounded-full border-4 border-[#f5f1eb] z-10"></div>
